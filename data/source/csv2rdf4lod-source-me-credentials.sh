...
source /etc/prizms/prizms/ckan/datahub.io/csv2rdf4lod-source-me-for-ckan-credentials.sh
source /etc/prizms/prizms/triple-store/virtuoso/csv2rdf4lod-source-me-for-virtuoso-credentials.sh
