...
static char rcsid[] not_used = {"$Id: WWWUInt16.cc 27180 2013-10-01 17:48:35Z jimg $"};
...
void
WWWUInt16::print_val(FILE *os, string, bool /*print_decl_p*/)
{
    write_simple_variable(os, this);
}

void
WWWUInt16::print_val(ostream &strm, string, bool /*print_decl_p*/)
{
